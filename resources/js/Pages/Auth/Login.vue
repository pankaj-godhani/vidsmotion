        ...
        <div class="relative z-10 flex min-h-screen">
                ...
                <div class="relative z-10 flex flex-col justify-center items-center p-12 w-full">
                    <div class="max-w-md text-center">
                        ...
                        <p class="text-xl text-white mb-8 drop-shadow-lg">
                            Experience the future of AI video generation. Create stunning videos with the power of artificial intelligence.
                        </p>
                        ...
                        <div class="space-y-4 text-left">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-white drop-shadow-md">Advanced AI video generation</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <div class="w-2 h-2 bg-blue-500 rounded-full animate-pulse" style="animation-delay: 0.5s;"></div>
                                <span class="text-white drop-shadow-md">Lightning-fast processing</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <div class="w-2 h-2 bg-cyan-500 rounded-full animate-pulse" style="animation-delay: 1s;"></div>
                                <span class="text-white drop-shadow-md">Professional quality output</span>
                            </div>
                        </div>
                        ...
                        <div class="mt-8 relative">
                            <div class="w-full h-32 bg-gradient-to-r from-purple-600/20 to-blue-600/20 rounded-lg border border-white/20 backdrop-blur-sm flex items-center justify-center">
                                <div class="text-center">
                                    ...
                                    <p class="text-white/60 text-sm">AI Video Preview</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w-full lg:w-1/2 flex flex-col justify-center p-8 lg:p-12">
                <div class="max-w-md mx-auto w-full">
                    ...
                    <!-- Status Message -->
                    <div v-if="status" class="mb-6 p-4 bg-green-500/20 border border-green-500/30 rounded-lg text-green-400 text-sm">
                        {{ status }}
                    </div>
                            ...
                            <div class="flex items-center justify-between">
                                <label class="flex items-center">
                                    <Checkbox
                                        ...
                                        class="rounded border-gray-600 text-purple-600 focus:ring-purple-500/20"
                                    />
