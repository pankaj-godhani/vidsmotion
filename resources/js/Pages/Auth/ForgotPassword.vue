                ...
                <div class="relative z-10 flex flex-col justify-center items-center p-12 w-full">
                    <div class="max-w-md text-center">
                        ...
                        <p class="text-xl text-white mb-8 drop-shadow-lg">
                            Don't worry, it happens to the best of us. We'll help you get back to creating amazing AI videos.
                        </p>
                        ...
                        <div class="space-y-4 text-left">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-white drop-shadow-md">Secure password reset</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <div class="w-2 h-2 bg-blue-500 rounded-full animate-pulse" style="animation-delay: 0.5s;"></div>
                                <span class="text-white drop-shadow-md">Quick email delivery</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <div class="w-2 h-2 bg-cyan-500 rounded-full animate-pulse" style="animation-delay: 1s;"></div>
                                <span class="text-white drop-shadow-md">Back to creating in minutes</span>
                            </div>
                        </div>
                ...
                <div class="max-w-md mx-auto w-full">
                    ...
                    <div class="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-8">
                        <div class="text-center mb-8">
                            ...
                            <p class="text-gray-400">No problem! Enter your email and we'll send you a reset link.</p>
                        </div>
